...
namespace UnityEngine.InputSystem.Samples
{
    ...
    public class InputControlVisualizer : InputVisualizer
    {
        ...
        /// <summary>
        /// <Joystick>/stick/x  | -1 ÐÓËÜ
        /// <Joystick>/trigger  | 1 À  êíîïêà
        /// <HID::LiteStar EMSI FORCE RACING WHEEL>/button2  | 0   B êíîïêà
        /// </summary>
        public string RealNameAxis;
        public bool rul; public bool PedalkA, PedalkB, PedalkC;
