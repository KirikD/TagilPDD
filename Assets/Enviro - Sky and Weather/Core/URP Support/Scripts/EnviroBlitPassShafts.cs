...
namespace UnityEngine.Rendering.LWRP
{
    ...
    /// </summary>
    internal class EnviroBlitPassShafts : ScriptableRenderPass
    {
        ...
        public EnviroBlitPassShafts(RenderPassEvent renderPassEvent, Material blitMaterial, Material clearMaterial)
        {
        ...
        public void Setup(Camera myCam, RenderTargetIdentifier source, RenderTargetHandle destination, Transform lightSource, Color treshold, Color clr)
        {
            this.myCam = myCam;
            this.source = source;
