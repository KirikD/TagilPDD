...
{
    internal class EnviroDistanceBlurPass : ScriptableRenderPass
    {
        ...
        /// </summary>
        public EnviroDistanceBlurPass(RenderPassEvent renderPassEvent, Material blitMaterial, Texture2D distributionTexture)
        {
        ...
        public void Setup(Camera myCam, RenderTargetIdentifier source, RenderTargetHandle destination)
        {
            this.myCam = myCam;
            this.source = source;
